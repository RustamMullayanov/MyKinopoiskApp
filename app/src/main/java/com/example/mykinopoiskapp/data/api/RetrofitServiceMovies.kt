...
interface RetrofitServiceMovies {
    ...
    @GET("/movie?field=type&search=movie&limit=20&field=year&search=2021&sortField=votes.imdb&sortType=-1${BuildConfig.MY_TOKEN}")
    fun getMoviesList(): Single<KinopoiskResponse>

    @GET("/movie?${BuildConfig.MY_TOKEN}&sortField=votes.imdb&sortType=-1&field=type&search=movie&limit=15&field=name")
